...
public abstract class AbstractFirefighterUpdater implements Updater{
    private AbstractFirefighter firefighter;
    private Elements<Set<Position>> fire;
    private final int columnCount;
    private final int rowCount;

    public AbstractFirefighterUpdater(AbstractFirefighter firefighter, Elements<Set<Position>> fire, int columnCount, int rowCount) {
